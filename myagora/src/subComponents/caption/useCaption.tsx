...
export const CaptionContext = React.createContext<{
  ...
  // AI Meeting Note Summarizer states
  isSummarizerOpen: boolean;
  setIsSummarizerOpen: React.Dispatch<React.SetStateAction<boolean>>;
  meetingSummary: string;
  setMeetingSummary: React.Dispatch<React.SetStateAction<string>>;
...
const CaptionProvider: React.FC<CaptionProviderProps> = ({
  ...
  // AI Meeting Note Summarizer states
  const [isSummarizerOpen, setIsSummarizerOpen] = React.useState<boolean>(false);
  const [meetingSummary, setMeetingSummary] = React.useState<string>('');
